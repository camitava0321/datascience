...
#%%- Load the market reasearch dataset
trainingData = pd.read_csv('marketResearchData1.csv')
print (trainingData)
...
trainingData.plot(x='age', y='spend', linewidth=0, marker='o', color='000', ax=ax[0,0])
