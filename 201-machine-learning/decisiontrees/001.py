...
#The decision tree structure can be analysed to gain insight on the relation 
#between the features and the target to predict. 
...
#It stores the entire tree structure and allows access to low level attributes. 
