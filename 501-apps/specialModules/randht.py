...
#RANDHT generates n observations 
#distributed as some continous heavy-tailed distribution. 
#Options are 
#power law, log-normal, stretched, exponential, power law with cutoff, and exponential. 
